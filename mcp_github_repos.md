...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- | ------------ |
| [Agent Scan][link_github_com_snyk_agent_scan] (PyPI `snyk-agent-scan`; legacy path `invariantlabs-ai/mcp-scan` redirects here; see [Invariant “Introducing MCP-Scan”][link_invariantlabs_ai_blog_introducing_mcp_scan])                                                                                                                                                                                                                                                                                                                                                               | Scans agent components for prompt injection, tool poisoning, toxic flows, and related risks                 | Useful for developer workflow and CI-style scanning; do not double-count as a separate “Invariant repo” | 2026-05-06 |
| [MCP Scanner][link_github_com_cisco_ai_defense_mcp_scanner]                                                                                                                                                                                                                                                                                                                                     | Scans MCP servers/tools using multiple engines                                                              | Useful for server security review                         | 2026-05-06 |
| [MCP Security][link_github_com_antgroup_mcp_security] (MCPScan)                                                                                                                                                                                                                                                                                                                                         | Detects metadata pollution, tool poisoning, malicious URLs, unsafe code snippets, and exfiltration patterns | Review rules, false positives, and offline/cloud behavior | 2026-05-06 |
| [MCP Scan][link_github_com_rodolfboctor_mcp_scan] · [MCP Security Scanner][link_github_com_ogulcanaydogan_mcp_security_scanner]                                                                                                                                                                                                                                         | Scans installed MCP server configs and manifests                                                            | Useful for local developer machines and CI gates          | 2026-05-06 |
| [MCP Shield][link_github_com_riseandignite_mcp_shield] · [Mcpshield][link_github_com_mcpshield_mcpshield] · [MCP Shield][link_github_com_gaboitb_mcp_shield]                                                                                                                                                                                           | Detects tool poisoning, exfiltration channels, and cross-origin escalation patterns                         | Verify maintainer and current repository                  | 2026-05-06 |
| [MCP Guardian][link_github_com_eqtylab_mcp_guardian]                                                                                                                                                                                                                                                                                                                                                     | Helps manage assistant access to MCP servers                                                                | Useful for human approval and local control               | 2026-05-06 |
| [Mcpproxy Go][link_github_com_smart_mcp_proxy_mcpproxy_go]                                                                                                                                                                                                                                                                                                                                       | Routes and manages access to multiple MCP servers                                                           | Review sandboxing, quarantine, and policy features        | 2026-05-06 |
| [mcpwatch][link_github_com_lazymac2x_mcpwatch]                                                                                                                                                                                                                                                                                                                                                         | MCP server security scanning (Go; project name **mcpwatch**)                                                                                | Track capabilities and maintenance status; distinct from **mcp-watch** below                 | 2026-05-06 |
| [mcp-watch][link_github_com_kapilduraphe_mcp_watch] (npm `mcp-watch`)                                                                                                                                                                                                                                                                                                                                                         | Descriptor-focused MCP security scanner (Node)                                                                                | Overlaps conceptually with other scanners—pick one per pipeline; not the same repo as mcpwatch                 | 2026-05-06 |
| [SecureMCP][link_github_com_makalin_securemcp]                                                                                                                                                                                                                                                                                                                                                         | Audits MCP usage: OAuth tokens, prompt injection probes, TLS/auth posture                                                                                | Validate reporting format before executive consumption                 | 2026-05-06 |
| [AI-Infra-Guard][link_github_com_tencent_ai_infra_guard]                                                                                                                                                                                                                                                                                                                                                         | Tencent Zhuque Lab platform: MCP/agent skills scanning, infra checks, jailbreak eval, and related workflows                                                                                | Broad surface—scope which modules you enable; see [conference talks](mcp_conference_talks.md) for MCP briefing PDF                 | 2026-05-06 |
| [mcp-context-protector][link_github_com_trailofbits_mcp_context_protector]                                                                                                                                                                                                                                                                                                                                                         | Client-side MCP wrapper emphasizing malicious context / description attacks                                                                                | Complements scanners and gateways; read Trail of Bits blog series for threat model                 | 2026-05-06 |
| [MCP-Defender][link_github_com_mcp_defender_mcp_defender]                                                                                                                                                                                                                                                                                                                                                         | Desktop proxy that inspects and gates MCP sessions from common AI IDEs                                                                                | AGPL; confirm trust model for signature / LLM-assisted checks                 | 2026-05-06 |
| [defenter-proxy][link_github_com_defenter_ai_defenter_proxy]                                                                                                                                                                                                                                                                                                                                                         | Semantic MCP + agent action broker (VS Code / Cursor paths)                                                                                | Cloud-assisted policy—review data handling and availability SLOs                 | 2026-05-06 |
| [MCP-Dandan][link_github_com_82ch_mcp_dandan]                                                                                                                                                                                                                                                                                                                                                         | Desktop MCP session monitor (Electron UI)                                                                                | Operational noise vs. security signal—tune before production SOC feeds                 | 2026-05-06 |
| [MCP Audit extension][link_github_com_agentity_com_mcp_audit_extension]                                                                                                                                                                                                                                                                                                                                                         | VS Code extension: logs/forwards Copilot MCP tool calls for audit                                                                                | IDE-only visibility; pair with server-side controls                 | 2026-05-06 |
| [MCP Ethical Hacking][link_github_com_cmpxchg16_mcp_ethical_hacking]                                                                                                                                                                                                                                                                                                                                                         | Educational MCP samples illustrating abuse classes                                                                                | **Authorized testing only**; lab isolation                 | 2026-05-06 |
| [octocode-mcp][link_github_com_bgauryy_octocode_mcp]                                                                                                                                                                                                                                                                                                                                                         | Research-oriented MCP tooling for GitHub-centric dev workflows ([octocode.ai](https://octocode.ai))                                                                                | Requires GitHub auth—treat tokens like production secrets                 | 2026-05-06 |
...
| [MCP Doctor][link_github_com_realwigu_mcp_doctor] · [MCP Doctor][link_github_com_agentopssec_mcp_doctor]                                                                                                                                                                                                                                                                       | Detects broken or risky MCP configs                                                                         | Useful for developer hygiene                              | 2026-05-06 |

## Checklists and governance artifacts

| Repository / Tool | What It Helps With | Summary | Last updated |
| --- | --- | --- | --- |
| [MCP Security Checklist][link_github_com_slowmist_mcp_security_checklist] | Structured review items for MCP design, deployment, and operations | Complements automated scanners; not a substitute for testing | 2026-05-06 |

## Representative security-product MCP servers

| Repository / Tool | What It Helps With | Summary | Last updated |
| --- | --- | --- | --- |
| [Semgrep MCP][link_github_com_semgrep_mcp] | Run [Semgrep](https://semgrep.dev/) on code from an MCP client | Tokens, deployment mode, and repo scope; treat scan targets as sensitive | 2026-05-06 |
| [Burp Suite MCP][link_github_com_portswigger_mcp_server] | Drive [Burp Suite](https://portswigger.net/burp) web testing via MCP | **Authorized testing only**; findings and session material need engagement-grade handling | 2026-05-06 |
| [Google Security Operations MCP][link_github_com_google_mcp_security] | Access Google security operations / threat intel products via MCP | Cloud identity least privilege; audit API usage and data residency | 2026-05-06 |
| [Ghidra MCP][link_github_com_lauriewired_ghidramcp] | **Reverse engineering:** drive [Ghidra](https://ghidra-sre.org/) from an MCP client | Malware and IP in dedicated labs; see integrations page for alternates (e.g. GhidrAssist) | 2026-05-06 |
| [radare2-mcp][link_github_com_radareorg_radare2_mcp] | **Reverse engineering:** drive [Radare2](https://rada.re/) from an MCP client | Malware and IP in dedicated labs; confirm tool scope against untrusted binaries | 2026-05-06 |
| [ida-pro-mcp][link_github_com_mrexodia_ida_pro_mcp] | **Reverse engineering:** drive [IDA Pro](https://hex-rays.com/ida-pro/) from an MCP client | Commercial license; malware/IP in dedicated labs; see integrations page for headless IDA options | 2026-05-06 |
| [binary_ninja_mcp][link_github_com_fosdickio_binary_ninja_mcp] | **Reverse engineering:** drive [Binary Ninja](https://binary.ninja/) from an MCP client | Commercial license; malware and IP in dedicated labs | 2026-05-06 |
| [jadx-ai-mcp][link_github_com_zinja_jadx_ai_mcp] | **Mobile / APK analysis:** drive [JADX](https://github.com/skylot/jadx) from an MCP client | APKs may contain secrets and PII; use isolated analysis; see integrations page for APKTool, MobSF, etc. | 2026-05-06 |
| [Panther SIEM MCP][link_github_com_panther_labs_mcp_panther] | **SIEM:** query and operate [Panther](https://panther.com/) via MCP | SOC-tier data access; separate credentials from analyst laptops; confirm transport and retention | 2026-05-06 |
| [Wazuh MCP][link_github_com_gbrigandi_mcp_server_wazuh] | **SIEM / XDR:** drive [Wazuh](https://wazuh.com/) from an MCP client | SOC-tier data access; least privilege on Wazuh API keys; confirm transport and retention | 2026-05-06 |
| [TheHive MCP][link_github_com_gbrigandi_mcp_server_thehive] | **Case management:** drive [TheHive](https://strangebee.com/thehive/) from an MCP client | Incident data is sensitive; restrict API users; confirm transport and retention | 2026-05-06 |
| [Cortex MCP][link_github_com_gbrigandi_mcp_server_cortex] | **SOAR / analyzers:** drive [Cortex](https://strangebee.com/cortex/) from an MCP client | Analyzer outputs may include secrets; least privilege; confirm transport and retention | 2026-05-06 |
...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- | ---------------------------------------------------------------- | ------------ |
| [Fastmcp][link_github_com_prefecthq_fastmcp]                                                                                                                                                   | Rapid MCP server development                      | Ensure safe defaults, auth, and tool review                      | 2026-05-06 |
| [Langchain MCP Adapters][link_github_com_langchain_ai_langchain_mcp_adapters]                                                                                                             | Lets LangChain agents use MCP tools               | Review tool routing and untrusted output handling                | 2026-05-06 |
| [Spring Ai][link_github_com_spring_projects_spring_ai]                                                                                                                                   | Java/Spring MCP client/server support             | Review OAuth, API key handling, and enterprise policy support    | 2026-05-06 |
| [MCP Handler][link_github_com_vercel_mcp_handler]                                                                                                                                                 | Deploy MCP servers in web/serverless environments | Review remote auth and tenant isolation                          | 2026-05-06 |
| [Fastapi MCP][link_github_com_tadata_org_fastapi_mcp] · [Fastapi MCP][link_github_com_lakshmana64_fastapi_mcp]                                                       | Exposes APIs as MCP tools                         | High risk if endpoints are exposed without review                | 2026-05-06 |
| [Modelfetch][link_github_com_phuctm97_modelfetch] · [Easymcp][link_github_com_secretiveshell_easymcp]                                                             | Boilerplates and helper libraries                 | Check for auth, validation, logging, and maintained dependencies | 2026-05-06 |
| [workers-mcp][link_github_com_cloudflare_workers_mcp]                                                                                                                                                   | Cloudflare Worker ↔ local MCP bridge (CLI + Worker helpers)                      | Remote MCP guidance supersedes some older patterns—follow current Cloudflare Agents docs; sandbox Worker secrets                 | 2026-05-06 |

## MCP hosting and enterprise runtimes

| Repository / Tool | Why It Matters | Summary | Last updated |
| --- | --- | --- | --- |
| [ToolHive][link_github_com_stackloklabs_toolhive] | Open-source MCP platform: container-isolated servers, identity hooks, K8s operator, observability | Distinct from [osv-mcp][link_github_com_stackloklabs_osv_mcp] in the integrations catalog—both are Stacklok ecosystem | 2026-05-06 |

## Server discovery and awesome lists

| Repository / Source                                                                                                                                                                                                       | Why It Matters                                 | Summary                                           | Last updated |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- | -------------------------------------------------------- | ------------ |
| [punkpeye/awesome-mcp-servers — Awesome MCP Servers][link_github_com_punkpeye_awesome_mcp_servers]                                                                                                                                  | Canonical community awesome-list of MCP server repos; includes a long curated [#security][link_github_com_punkpeye_awesome_mcp_servers_security] section | Discovery only—not a trust boundary; verify each server, maintainer, and install path independently | 2026-05-06 |
| [Awesome MCP Servers][link_github_com_wong2_awesome_mcp_servers] · [mcpservers.org][link_mcpservers_org]                                                                                          | Categorized MCP server discovery               | Validate freshness, repo ownership, and install commands | 2026-05-06 |
| [Awesome MCP Servers][link_github_com_appcypher_awesome_mcp_servers]                                                                                                                              | Another curated server list                    | Cross-check duplicates and abandoned entries             | 2026-05-06 |
